...
require File.dirname(__FILE__) + '/../../controllers/block_add_blocks_plugin_myprofile_controller'


# Re-raise errors caught by the controller.
class BlockAddBlocksPluginMyprofileControllerController; def rescue_action(e) raise e end; end

class BlockAddBlocksPluginMyprofileControllerTest < ActionController::TestCase

  def setup
    @controller = BlockAddBlocksPluginMyprofileController.new
