...
require File.dirname(__FILE__) + '/../../controllers/block_add_blocks_plugin_admin_controller'


# Re-raise errors caught by the controller.
class BlockAddBlocksPluginAdminControllerController; def rescue_action(e) raise e end; end

class BlockAddBlocksPluginAdminControllerTest < ActionController::TestCase

  def setup
    @controller = BlockAddBlocksPluginAdminController.new
    ...
    @environment.enabled_plugins = ['BlockAddBlocksPlugin']
    ...
    BlockAddBlocksBlock.delete_all
    @block = BlockAddBlocksBlock.new
