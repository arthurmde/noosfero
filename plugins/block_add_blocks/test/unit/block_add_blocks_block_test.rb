...
class BlockAddBlocksBlockTest < ActiveSupport::TestCase
  ...
  should 'describe itself' do
    assert_not_equal Block.description, BlockAddBlocksBlock.description
  end
  ...
  should 'url_params return myprofile url params if the owner is a profile' do
    ...
    params[:controller] = "block_add_blocks_plugin_myprofile"
  ...
  should 'url_params return admin url params if the owner is an environment' do
    ...
    params = {:block_id => block.id}
    params[:controller] = "block_add_blocks_plugin_admin"
    assert_equal params, block.url_params
  end
